...
public static void main(String[] args) {
	...
	// JoinForm이 가진 데이터형은 총 3개 (JoinForm JPanel Object)
}
*/
public class JoinForm extends JPanel {
	...
	public JoinForm() {
		...
		ButtonGroup gb=new ButtonGroup(); // 그룹을 잡지 않으면 한개씩 선택 불가
		gb.add(rb1);
		gb.add(rb2);
		
		b1=new JButton("중복체크");
		
		title.setFont(new Font("굴림체",Font.BOLD,45)); // <h1><b>회원가입</b></h>
		...
		la3.setBounds(300, 170, 80, 30); // 옆으로 옮기기 1,3항 합 / 밑으로 옮기기 2,4항 합
		...
		js.setBounds(380, 415, 400, 200);
		add(la10); add(js);
		
		box1=new JCheckBox("샐러드");
		box2=new JCheckBox("빵");
		box3=new JCheckBox("과자");
		box4=new JCheckBox("야식");
